  ...
  return (
    <div className="bg-[#0f172a]">
      <div
        ...
        id="about">
        <div className="max-w-3xl mx-2 md:mx-auto  px-6 py-8 rounded-md shadow-md shadow-secondaryColor bg-opacity-5">
          <p className="text-justify text-white text-xs md:text-base ">
